<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_ListSanPham.aspx.cs" Inherits="admin_page_module_function_module_sanpham_module_ListSanPham" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    <script type="text/javascript">
        ...
        function checkNULL() {
            var CityName = document.getElementById('<%= txt_Tensanpham.ClientID%>');
    ...
    <div class="card card-block">
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="product_id" Width="100%">
                <Columns>
    ...
    <dx:ASPxPopupControl ID="popupControl" runat="server" Width="800px" Height="600px" CloseAction="CloseButton" ShowCollapseButton="True" ShowMaximizeButton="True" ScrollBars="Auto" CloseOnEscape="true" Modal="True"
        ...
        HeaderText="Thông tin sản phẩm" AllowDragging="True" PopupAnimationType="Fade" EnableViewState="False" AutoUpdatePosition="true" ClientSideEvents-CloseUp="function(s,e){grvList.Refresh();}">
        <ContentCollection>
                            ...
                            <div class="div_content col-12">
                                <div class="col-9">
                                    <div class="col-12 form-group">
                                        <label class="col-2 form-control-label">Nhóm sản phẩm:</label>
                                        <div class="col-10">
                                            <dx:ASPxComboBox ID="ddlloaisanpham" runat="server" ValueType="System.Int32" TextField="productcate_title" ValueField="productcate_id" ClientInstanceName="ddlloaisanpham" CssClass="" Width="95%"></dx:ASPxComboBox>
                                        </div>
                                    </div>
                                    <div class="col-12 form-group">
                                        <label class="col-2 form-control-label">Tên sản phẩm:</label>
                                        <div class="col-10">
                                            <asp:TextBox ID="txt_Tensanpham" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="90%"> </asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-12 form-group">
                                        <label class="col-2 form-control-label">Tóm tắt:</label>
                                        <div class="col-10">
                                            <textarea class="form-control" runat="server" id="txt_Summary" rows="3" style="width: 90%"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12 form-group">
                                        <label class="col-2 form-control-label">Giá bán sản phẩm:</label>
                                        <div class="col-10">
